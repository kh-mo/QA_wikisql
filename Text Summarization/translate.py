...
tf.app.flags.DEFINE_string("data_dir", "S:/class/seqtoseq/data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "S:/class/seqtoseq/train", "Training directory.")
