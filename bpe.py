...
def learn_bpe(infile, outfile):
    ...
    # 이건 뭐고 왜 하는거지???
    state, indices = get_pair_statistics(sorted_vocab)
    outfile.close()
...
if __name__ == "__main__":
    infile = open(os.path.join(os.getcwd(), "preprocess/train.txt"), "r")
    outfile = open(os.path.join(os.getcwd(), "preprocess/codes.txt"), "w")
    learn_bpe(infile, outfile)
    apply_bpe()
